...
uint8_t KeyboardMatrix[2][5][14] = {
  {
    ...
    {LEFT_CTRL, LEFT_GUI, LEFT_ALT, 0, 0, HID_KEYB_USAGE_SPACE, 0, 0, 0, HID_KEYB_USAGE_LEFT_ARROW, HID_KEYB_USAGE_DOWN_ARROW, HID_KEYB_USAGE_UP_ARROW, HID_KEYB_USAGE_RIGHT_ARROW, 0}
  },
  {
